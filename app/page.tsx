      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="mb-6 flex flex-col md:flex-row gap-4 items-center">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => router.push('/profile')} className="flex items-center gap-2 bg-slate-900 hover:bg-slate-800 border border-slate-700 px-3 py-2 rounded-lg transition-all">
